...
HD_PWD='C:/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Stopwatch_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Stopwatch_main.tcl

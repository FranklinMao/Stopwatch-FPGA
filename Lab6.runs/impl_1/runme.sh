...
HD_PWD='C:/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Stopwatch_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Stopwatch_main.tcl -notrace
